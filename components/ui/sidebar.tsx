...
>(
  (
    ...
    // Agregamos un estado para que podamos usar data-state="expanded" o "collapsed".
    // Esto facilita el estilo de la barra lateral con clases de Tailwind.
      ...
      >
        ...
        <div
          className={cn(
            ...
            // Ajusta el relleno para las variantes flotante y empotrada.
            variant === "floating" || variant === "inset"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Aumenta el área de clic del botón en dispositivos móviles.
